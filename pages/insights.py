...
column1 = dbc.Col(
    [
        ...
        dcc.Markdown(
            '''
            Looking at the effect of increased expenditure, you can see that class 0 (1, low basic) and class 2 (3, high basic), you can see a positive effect but with class 1 (2, mid basic)
